...
{
	/*
	 * 各类驱动都可能出现的错误：DRV+7位数字 错误编号 错误描述 DRV0000001 未知错误 DRV0000002 超时错误
	 * DRV0000003 打开串口失败 DRV0000004 向串口发送数据失败 DRV0000005 接口参数错误 DRV0000006
	 * 找不到动态链接库 DRV0000007 动态链接库加载错误 DRV0000008 通讯连接没有建立
	 */
	...
	/*
	 * 某类驱动出现的错误：3位设备类型代码+7位数字 设备类型代码 设备描述 PIN 密码键盘 ICC IC卡键盘 IDC 二代证（ID卡） FIG
	 * 指纹仪 RDC 刷卡器 SIN 电子签名
	 */
